...
# @brief         :
# -----
# Last Modified: August 19 2023, 22:05:56, Saturday
...
if { $argc != 5 } {
    ...
    set place_tcl_path [lindex $argv 2]
    ...
    launch $benchmark_name $dcp_path $place_tcl_path $placed_checkpoint_path $routed_checkpoint_path
}
"""
...
with concurrent.futures.ThreadPoolExecutor(max_workers=max_workers) as executor:
    try:
        for benchmark_name in benchmark_names:
            ...
            with open(place_tcl_path, "w") as fp:
                fp.write("place_cell { \\\n")

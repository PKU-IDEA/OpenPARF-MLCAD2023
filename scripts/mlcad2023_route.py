...
# @brief         :
# -----
# Last Modified: August 21 2023, 14:12:22, Monday
...
proc launch {
    ...
    if {[file exists $routed_checkpoint_path] == 0} {
        ...
        highlight_objects -color red  [get_cells -hierarchical -filter {PRIMITIVE_TYPE =~ *DSP*}]
        highlight_objects -color green  [get_cells -hierarchical -filter {PRIMITIVE_TYPE =~ *RAMB*}]
    ...
    report_design_analysis -congestion -min_congestion_level 4
...
if { $argc != 5 } {
    ...
    set routed_checkpoint_path [lindex $argv 4]
    puts $benchmark_name
    puts $dcp_path
    puts $pl_path
    puts $placed_checkpoint_path
    puts $routed_checkpoint_path
    launch $benchmark_name $dcp_path $pl_path $placed_checkpoint_path $routed_checkpoint_path
}
"""

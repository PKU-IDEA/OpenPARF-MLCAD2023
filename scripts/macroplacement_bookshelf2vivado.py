...
# @brief         :
# -----
# Last Modified: October 17 2023, 16:50:41, Tuesday
...
parser.add_argument('-b', "--bm_dir", type=str, help="the benchmark folder", required=True)
parser.add_argument('-p', "--sol_dir", type=str, help="the solution folder (solution.pl)", required=True)

...
typedef ehbookshelfparser::Parser::token token;
typedef ehbookshelfparser::Parser::token_type token_type;
...
%option prefix="EHBookshelfParser"
...
(?i:INPUT_CLOCK)             { return token::KWD_INPUT_CLOCK; }
(?i:INPUT_CTRL)              { return token::KWD_INPUT_CTRL; }
...
(?i:InstanceToRegionConstraintMapping) {return token::KWD_REGION_MAPPING; }
...
Scanner::Scanner(std::istream* in, std::ostream* out)
    : EHBookshelfParserFlexLexer(in, out)
{}
...
int EHBookshelfParserFlexLexer::yylex()
{
    std::cerr << "in EHBookshelfParserFlexLexer::yylex() !" << std::endl;
    return 0;
}
...
int EHBookshelfParserFlexLexer::yywrap()
{
    return 1;
}

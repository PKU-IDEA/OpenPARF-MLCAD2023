...
PYBIND11_MAKE_OPAQUE(Region);
PYBIND11_MAKE_OPAQUE(RegionConstraint);
PYBIND11_MAKE_OPAQUE(ShapeElement);
PYBIND11_MAKE_OPAQUE(ShapeModel);
PYBIND11_MAKE_OPAQUE(Shape);
PYBIND11_MAKE_OPAQUE(ShapeConstraint);
...
void bind_database(py::module &m) {
  ...
  py::class_<Region, Object>(m, "Region")
          .def(py::init<>())
          .def(py::init<IndexType>())
          .def("name", &Region::name)
          .def("setName", (void(Region::*)(std::string const &)) & Region::setName)
          .def("bbox", &Region::bbox)
          //   .def('setBbox', )
          //   .def("instIds", &Region::instIds)
          .def("numInsts", &Region::numInsts)
          .def("instId", (IndexType(Region::*)(IndexType)) & Region::instId)
          .def("memory", &Region::memory)
          .def("__repr__", [](Region const &rhs) {
            std::stringstream os;
            os << rhs;
            return os.str();
          });
  py::class_<RegionConstraint, Object>(m, "RegionConstraint")
          .def(py::init<>())
          .def(py::init<IndexType>())
          .def("region", (Region & (RegionConstraint::*) (IndexType)) & RegionConstraint::region)
          .def("region", (Region & (RegionConstraint::*) (std::string const &) ) & RegionConstraint::region)
          .def("regionId", (IndexType(RegionConstraint::*)(std::string const &)) & RegionConstraint::regionId)
          .def("numRegions", &RegionConstraint::numRegions)
          .def("ifExist", (bool(RegionConstraint::*)(IndexType)) & RegionConstraint::ifExist)
          .def("memory", &RegionConstraint::memory)
          .def("__repr__", [](RegionConstraint const &rhs) {
            std::stringstream os;
            os << rhs;
            return os.str();
          });
  py::class_<ShapeElement, Object>(m, "ShapeElement")
          .def(py::init<>())
          .def("model_id", &ShapeElement::model_id)
          .def("offset", &ShapeElement::offset)
          .def("memory", &ShapeElement::memory)
          .def("__repr__", [](ShapeElement const &rhs) {
            std::stringstream os;
            os << rhs;
            return os.str();
          });
  py::class_<ShapeModel, Object>(m, "ShapeModel")
          .def(py::init<>())
          .def(py::init<IndexType>())
          .def("type", &ShapeModel::type)
          .def("name", &ShapeModel::name)
          .def("numShapeElements", &ShapeModel::numShapeElements)
          .def("shapeElement", (ShapeElement & (ShapeModel::*) (IndexType)) & ShapeModel::shapeElement)
          .def("memory", &ShapeModel::memory)
          .def("__repr__", [](ShapeModel const &rhs) {
            std::stringstream os;
            os << rhs;
            return os.str();
          });
  py::class_<Shape, Object>(m, "Shape")
          .def(py::init<>())
          .def(py::init<IndexType>())
          .def("shapeModelId", &Shape::shapeModelId)
          .def("name", &Shape::name)
          .def("numInstances", &Shape::numInstances)
          .def("instId", (IndexType(Shape::*)(IndexType)) & Shape::instId)
          .def("memory", &Shape::memory)
          .def("__repr__", [](Shape const &rhs) {
            std::stringstream os;
            os << rhs;
            return os.str();
          });
  py::class_<ShapeConstraint, Object>(m, "ShapeConstraint")
          .def(py::init<>())
          .def(py::init<IndexType>())
          .def("numShapeModels", &ShapeConstraint::numShapeModels)
          .def("shapeModel", (ShapeModel & (ShapeConstraint::*) (IndexType)) & ShapeConstraint::shapeModel)
          .def("shapeModelId", (IndexType(ShapeConstraint::*)(std::string const &)) & ShapeConstraint::shapeModelId)
          .def("numShapes", &ShapeConstraint::numShapes)
          .def("shape", (Shape & (ShapeConstraint::*) (IndexType)) & ShapeConstraint::shape)
          .def("memory", &ShapeConstraint::memory)
          .def("__repr__", [](ShapeConstraint const &rhs) {
            std::stringstream os;
            os << rhs;
            return os.str();
          });
  ...
  database.def(py::init<>())
          ...
          .def("readEHBookshelf", (void(Database::*)(std::string const &)) & Database::readEHBookshelf)
          ...
          .def("regionConstraint", (RegionConstraint & (Database::*) ()) & Database::regionConstraint,
                  py::return_value_policy::reference_internal)
          .def("shapeConstraint", (ShapeConstraint & (Database::*) ()) & Database::shapeConstraint,
                  py::return_value_policy::reference_internal);
  ...
  py::class_<PlaceDB>(m, "PlaceDB")
          ...
          .def("place_params", (PlaceParams const &(PlaceDB::*) () const) & PlaceDB::place_params,
                  py::return_value_policy::reference_internal)
          ...
          .def("shapeInsts", &PlaceDB::shapeInsts, py::return_value_policy::reference_internal)
          .def("inst2Shape", py::overload_cast<>(&PlaceDB::inst2Shape, py::const_),
                  py::return_value_policy::reference_internal)
          .def("regionInsts", &PlaceDB::regionInsts, py::return_value_policy::reference_internal)
          .def("inst2Region", py::overload_cast<>(&PlaceDB::inst2Region, py::const_),
                  py::return_value_policy::reference_internal)
          .def("collectRegionBoxes", &PlaceDB::collectRegionBoxes)
          .def("collectFlattenRegionBoxes", &PlaceDB::collectFlattenRegionBoxes)
          .def("apply",
          ...
          .def("writeMacroBookshelfPl", (bool(PlaceDB::*)(std::string const &)) & PlaceDB::writeMacroBookshelfPl)

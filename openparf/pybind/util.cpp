...
PYBIND11_MAKE_OPAQUE(VectorShapeModelType);
...
void bind_util(py::module& m) {
  ...
  py::enum_<ShapeModelType>(m, "ShapeModelType")
      .value("kDSPShape", ShapeModelType::kDSPShape)
      .value("kBRAMShape", ShapeModelType::kBRAMShape)
      .value("kCARRYShape", ShapeModelType::kCARRYShape)
      .value("kUnknown", ShapeModelType::kUnknown);
  ...
  BIND_VECTOR_TOLIST(VectorShapeModelType);

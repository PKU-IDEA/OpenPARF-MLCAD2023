...
using RegionConstraint       = database::RegionConstraint;

using ShapeElement           = database::ShapeElement;
using ShapeModel             = database::ShapeModel;
using Shape                  = database::Shape;
using ShapeConstraint        = database::ShapeConstraint;
// using ShapeModelMap          = ObjectMap<ShapeModel>;
// using ShapeMap               = ObjectMap<Shape>;

#endif   // OPENPARF_PYBIND_DATABASE_H_
